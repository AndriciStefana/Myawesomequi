...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void insertCategory(Category category) {
        ...
        cv.put(String.valueOf(CategoriesTable.COLUMN_NAME), category.getName());
        db.insert(String.valueOf(CategoriesTable.TABLE_NAME), null, cv);
    }
    ...
    public List<Category> getAllCategories() {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                category.setId(c.getInt(c.getColumnIndex(String.valueOf(CategoriesTable._ID))));
                category.setName(c.getString(c.getColumnIndex(String.valueOf(CategoriesTable.COLUMN_NAME))));
